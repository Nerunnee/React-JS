...
const ProfileCard = () => {
  return (
    <div className="h-115.75 w-66 bg-[url('/demon-slayer.jpg')] bg-cover bg-center border-r-5 text-white rounded-xl flex flex-col justify-end border-6 border-red-900">
